...
try {
    ...
    if(isset($_GET["id"])){
        ...
        $stmt = $con->prepare('DELETE FROM ligas WHERE id = :id');
...
?>
    ...
    <div id="srfbdth">
        <div class="dados">
            <p><?php echo $result["nome_liga"]; ?></p>
        </div>
        <div class="opicoes">
            <span class="leftbuttom"> <a href="atual-liga.php?id=<?php echo $result["id"]; ?>">Atualizar / Editar</a> </span>
