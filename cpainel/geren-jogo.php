...
try {
    ...
    if(isset($_GET["id"])){
        ...
        $stmt = $con->prepare('DELETE FROM jogos WHERE id = :id');
		...
		$query = $con->prepare('SELECT * FROM `jogos`');
...
?>
    ...
    <div id="srfbdth">
        <div class="dados">
            <p><?php echo $result["confronto"]; ?></p>
        </div>
        <div class="opicoes">
            <span class="leftbuttom"> <a href="atual-jogo.php?id=<?php echo $result["id"]; ?>">Atualizar / Editar</a> </span>
