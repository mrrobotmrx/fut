...
try {
    ...
    if(isset($_GET["id"])){
        ...
        $stmt = $con->prepare('DELETE FROM moments WHERE id = :id');
...
?>
    ...
    <div id="srfbdth">
        <div class="dados">
            <p><?php echo $result["titulo_moment"]; ?></p>
        </div>
        <div class="opicoes">
            <span class="leftbuttom"> <a href="atual-moments.php?id=<?php echo $result["id"]; ?>">Atualizar / Editar</a> </span>
